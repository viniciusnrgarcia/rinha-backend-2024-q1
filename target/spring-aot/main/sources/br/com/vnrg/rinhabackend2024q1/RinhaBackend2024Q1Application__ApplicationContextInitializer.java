 ...
 */
@Generated
public class RinhaBackend2024Q1Application__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new RinhaBackend2024Q1Application__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new RinhaBackend2024Q1Application__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
