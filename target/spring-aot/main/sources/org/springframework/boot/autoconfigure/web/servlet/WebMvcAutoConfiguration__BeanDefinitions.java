...
public class WebMvcAutoConfiguration__BeanDefinitions {
  ...
  /**
   * Bean definitions for {@link WebMvcAutoConfiguration.ProblemDetailsErrorHandlingConfiguration}.
   */
  @Generated
  public static class ProblemDetailsErrorHandlingConfiguration {
    /**
     * Get the bean definition for 'problemDetailsErrorHandlingConfiguration'.
     */
    public static BeanDefinition getProblemDetailsErrorHandlingConfigurationBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(WebMvcAutoConfiguration.ProblemDetailsErrorHandlingConfiguration.class);
      beanDefinition.setInstanceSupplier(WebMvcAutoConfiguration.ProblemDetailsErrorHandlingConfiguration::new);
      return beanDefinition;
    }
  }
