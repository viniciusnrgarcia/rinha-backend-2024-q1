...
* The original package name 'br.com.vnrg.rinha-backend-2024-q1' is invalid and this project uses 'br.com.vnrg.rinhabackend2024q1' instead.
...
```
$ docker run --rm rinha-backend-2024-q1:0.0.1-SNAPSHOT
```
